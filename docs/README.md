# Toodles Funzone – Documentation

| Doc | Description |
|-----|-------------|
| [DEPLOYMENT.md](./DEPLOYMENT.md) | General deployment guide |
| [EC2_MIGRATION.md](./EC2_MIGRATION.md) | EC2 migration and setup |
| [GOOGLE_OAUTH_SETUP.md](./GOOGLE_OAUTH_SETUP.md) | Google OAuth configuration |
| [NOTIFICATIONS.md](./NOTIFICATIONS.md) | Booking notifications (email, WhatsApp, Toodles intimation) |
| [OPERATING_HOURS_CODE.md](./OPERATING_HOURS_CODE.md) | Operating hours implementation |
